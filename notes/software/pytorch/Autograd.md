...
To define custom operations, torch has a special class called `torch.autograd.Function`. We can specify forward and backward passses for these functions, and they can enter the DAG.
